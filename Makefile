...
standard:
	...
	install -m 644 share/polkit-1/actions/org.tpfanco.tpfand.policy $(DESTDIR)/usr/share/polkit-1/actions/org.tpfanco.tpfand.policy
...
uninstall:
	...
	rm -f $(DESTDIR)/usr/share/polkit-1/actions/org.tpfanco.tpfand.policy
